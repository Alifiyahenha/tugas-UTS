...
<section class="hero-section">
  <div class="container hero-content">
    <h1 class="display-4 font-weight-bold">Selamat Datang di Bacainfo<br>Baca yang Kamu Suka, Kapan Saja.</h1>
    <div class="highlight-line"></div>
    <p class="lead">Dari gaya hidup, kesehatan, teknologi, hingga inspirasi hidup—semua ada di sini..</p>
      ...
      <div class="article-card w-100">
        ...
        <p>
          ...
          <?php if (count($words) > $wordLimit): ?>
            <a href="berita.php?id=<?= $row['id']; ?>" class="btn btn-primary">Read More</a>
          <?php endif; ?>
        </p>
      </div>
    </div>
